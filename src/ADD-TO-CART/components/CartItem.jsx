...
export default function CartItem({ item }) {
  ...
  return (
    <div className="rounded-3xl border border-neutral-300 xl:-11/12">
      <div className="flex flex-col gap-6 border-b border-neutral-300 px-4 py-6 sm:flex-row sm:items-center">
        <img className="mx-auto w-36 rounded-2xl bg-gray-300 p-4 sm:mx-0 sm:w-32" src={item.img} alt={item.name} />
